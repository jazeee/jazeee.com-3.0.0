      ...
      <Container maxWidth="md">
        ...
        >
          ...
          <Typography paragraph>
            In my <InternalLink to="../engineering-impact">previous post</InternalLink>, I go over
            the engineering costs of flaky tests.
          </Typography>
          <Typography paragraph>
            In this post, I will talk about strategies to achieve fully reliable tests, including
            across integration testing systems, such as Cypress, or Selenium.
          </Typography>
          <Typography variant="h2" paragraph color="secondary">
            Summary
          </Typography>
          <Typography paragraph>
            In order to tackle flaky tests, we need to understand what can cause them. By
            understanding their causes, we can focus on increasing test reliability, and even
            eliminate test flake. This increases our confidence in tests and helps engineers focus
            on actual test failures. It also significantly impacts engineering cost.
          </Typography>
          ...
          <Typography paragraph>
            ...
            values or date/time based values. We also tend to assume that web services will always
            work.
          </Typography>
          <Typography paragraph>
            Indeed, using random values or date/time dependent values in tests can uncover
            unexpected edge cases. Unfortunately, by doing this, we are pushing the onus of
            discovering edge cases onto our colleagues.
          </Typography>
          <Typography variant="h2" paragraph color="secondary">
          ...
          <Typography paragraph>
            Make this a high priority issue and notify all engineers via a visible communication
            channel such as a Slack channel. Consider creating a triage process and notify the code
            owner as quickly as possible. Consider disabling the test until resolved.
          </Typography>
          <Typography variant="h3" paragraph color="secondary">
            Use a Date/Time Mock Test Utility.
          </Typography>
          <Typography>
            All software testing environments have support software for mocking functions and
            values. Examples:
          </Typography>
          <List
            sx={{
          ...
          <Typography>
            Using fixed known values makes your test predictable and repeatable.
          </Typography>
          <List
            sx={{
              listStyleType: 'decimal',
          ...
          >
            <ListItem sx={{ display: 'list-item' }}>
              Random test values may not always work.
            </ListItem>
            <ListItem sx={{ display: 'list-item' }}>
              Random test values may make the test fragile.
            </ListItem>
            <ListItem sx={{ display: 'list-item' }}>
              Random test values can make it hard to identify the source of the failure - the
              failing value may be obscure.
            </ListItem>
            <ListItem sx={{ display: 'list-item' }}>
          ...
          >
            <ListItem sx={{ display: 'list-item' }}>
              <code>npm</code>, <code>pip</code>, <code>Github</code> are not guaranteed to always
              work.
            </ListItem>
            <ListItem sx={{ display: 'list-item' }}>
          ...
          <Typography>
            Tests that span parts the software stack introduce unpredictable latency. While the
            common mantra is to assume that these kinds of tests will be flaky, this can be avoided.
          </Typography>
          <List
            sx={{
              listStyleType: 'decimal',
          ...
          >
            ...
            <ListItem sx={{ display: 'list-item' }}>
              Often, the UI is waiting for an API response before updating. In order to make your
              test deterministic, wait for that API response to resolve, then verify that the UI
            ...
            <ListItem sx={{ display: 'list-item' }}>
              Avoid flickering, janky, or non-determinstic UI. Testing frameworks cannot be
              resilient to flake if your code repeatedly removes and adds DOM elements.
            </ListItem>
            <ListItem sx={{ display: 'list-item' }}>
          ...
          <Typography paragraph>
            This engineer wrote tests using the current date and the tests passed during their work
            day, but failed at 5 PM PST, every day. This engineer never saw the error, since they
            lived on the US east coast, and the failure occurred at 8 PM for them. Unfortunately,
            these test failures blocked all CI tests for the engineers in the US west coast, and
            also affected all users after 5 PM.
          </Typography>
          <Typography paragraph>
            One could argue that it was great that the tests identified the bug. This comes at the
            expense of blocking the entire team, and is therefore quite expensive. Instead, the
            tests should be made to be determinstic, by mocking the date/time for the edge cases. In
            doing so, the 5 PM PST scenario is tested continually, not just after 5 PM.
          </Typography>
          <Typography variant="h2" paragraph color="secondary">
            Conclusion
          </Typography>
          <Typography paragraph>
            ...
            complex non-deterministic test failures. We were then able to identify their root
            causes, and clean those up.
          </Typography>
          <Typography paragraph>
            As a measure of this success, I configured the continuous integration tests (including
            Cypress tests) to run every hour, for every day. These tests ran successfully throughout
            the December holidays without fail - until 2023-01-01 at midnight.
          </Typography>
          <Typography paragraph>
            The one test failure that occurred was one that I wrote to verify that the footer
            contained 2022. I failed to mock the date! It was a once a year failure, and a simple
            fix. No other tests failed during those two weeks. This means that no engineers were
            blocked from emergency deployments or other work during the holidays.
          </Typography>
          <Typography paragraph>
